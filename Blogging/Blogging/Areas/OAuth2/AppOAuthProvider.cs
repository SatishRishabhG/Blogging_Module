...
namespace Blogging.Areas.OAuth2
{
    /// <summary>
    ...
    public class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            // Initialization. 
            userManager = new UserRepository(new SqlConnection(ConfigurationManager.ConnectionStrings["GrapeCityBloggingEntities"].ConnectionString));
            string usernameVal = context.UserName;
            string passwordVal = context.Password;
            var user = userManager.GetUser(usernameVal, passwordVal);
